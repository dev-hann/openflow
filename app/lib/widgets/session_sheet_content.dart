...
class SessionSheetContent extends StatefulWidget {
  const SessionSheetContent({
  ...
  @override
  State<SessionSheetContent> createState() => _SessionSheetContentState();
}

class _SessionSheetContentState extends State<SessionSheetContent> {
  String _searchQuery = '';
