...
class PairVerifyRequest {
  /// Returns a new [PairVerifyRequest] instance.
  PairVerifyRequest({
    required this.pin,
    this.label,
  });
  ...
  /// Returns a new [PairVerifyRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PairVerifyRequest? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<PairVerifyRequest> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PairVerifyRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PairVerifyRequest> mapFromJson(dynamic json) {
    final map = <String, PairVerifyRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PairVerifyRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
