...
class ProviderModelsResponse {
  /// Returns a new [ProviderModelsResponse] instance.
  ...
  /// Returns a new [ProviderModelsResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ProviderModelsResponse? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<ProviderModelsResponse> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ProviderModelsResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ProviderModelsResponse> mapFromJson(dynamic json) {
    final map = <String, ProviderModelsResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ProviderModelsResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
