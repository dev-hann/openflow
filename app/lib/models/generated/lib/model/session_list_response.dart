...
class SessionListResponse {
  ...
  /// Returns a new [SessionListResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SessionListResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return SessionListResponse(
        sessions: SessionInfo.listFromJson(json[r'sessions']),
      );
    }
    return null;
  }
  ...
  static List<SessionListResponse> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SessionListResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SessionListResponse> mapFromJson(dynamic json) {
    final map = <String, SessionListResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SessionListResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
