...
class UpdateProviderRequest {
  /// Returns a new [UpdateProviderRequest] instance.
  ...
  /// Returns a new [UpdateProviderRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static UpdateProviderRequest? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<UpdateProviderRequest> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = UpdateProviderRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, UpdateProviderRequest> mapFromJson(dynamic json) {
    final map = <String, UpdateProviderRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UpdateProviderRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
