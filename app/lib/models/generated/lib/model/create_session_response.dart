...
class CreateSessionResponse {
  ...
  bool operator ==(Object other) =>
      ...
      other is CreateSessionResponse && other.id == id && other.title == title;
    ...
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'id'),
            'Required key "CreateSessionResponse[id]" is missing from JSON.');
        assert(json[r'id'] != null,
            'Required key "CreateSessionResponse[id]" has a null value in JSON.');
        assert(json.containsKey(r'title'),
            'Required key "CreateSessionResponse[title]" is missing from JSON.');
        assert(json[r'title'] != null,
            'Required key "CreateSessionResponse[title]" has a null value in JSON.');
        return true;
      }());
